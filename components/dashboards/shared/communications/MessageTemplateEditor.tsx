...
export const MessageTemplateEditor: React.FC = () => {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h3 className="text-xl font-black text-main ">Email Templates</h3>
      ...
      <p className="text-xs font-semibold text-muted">Available variables: {'{{name}}'}, {'{{email}}'}, {'{{phone}}'}. HTML is wrapped in the MCA King email shell automatically unless you paste a full HTML document.</p>

      <div>
        <h4 className="mb-2 text-sm font-black uppercase text-accent">Template Preview</h4>
        <iframe title="Template preview" srcDoc={htmlPreview} className="h-[460px] w-full rounded-xl border-2 border-line bg-surface " />
      </div>
