        ...
        return (
             ...
             <div className="p-4 sm:p-6 lg:p-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    {message && <p className="mb-4 text-sm text-secondary">{message}</p>}
                     ...
                     <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
                        <Card className="w-full max-w-md">
                            <form onSubmit={handleCreateOffer}>
                                <div className="p-6">
                                    <h3 className="text-lg font-black text-main ">Create Offer for {sanitizedSelectedDeal.businessInfo.legalName}</h3>
                                ...
                                <div className="p-4 bg-surface-muted -muted/50 border-t flex justify-end space-x-2">
                     ...
                     <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
                        <Card className="w-full max-w-md">
                            <form onSubmit={handleRequestDocument}>
                                <div className="p-6">
                                    <h3 className="text-lg font-black text-main ">Request Document</h3>
                                    <div className="mt-4">
